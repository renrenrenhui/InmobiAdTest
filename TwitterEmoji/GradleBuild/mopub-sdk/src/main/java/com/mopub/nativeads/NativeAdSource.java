...
class NativeAdSource {
    ...
    private int mCacheLimit = CACHE_LIMIT;
    ...
    void loadAds(@NonNull final Context context,
            ...
            final boolean cache) {
        loadAds(requestParameters, new MoPubNative(context, adUnitId, mMoPubNativeNetworkListener, cache));
    }
    ...
    @VisibleForTesting
    void replenishCache() {
        if (!mRequestInFlight && mMoPubNative != null && mNativeAdCache.size() < mCacheLimit) {
